  ...
  return (
    <div className='flex justify-between p-10'>
        <a href="" className='flex items-center gap-5 text-white font-semibold text-2xl'>
          <Image src="https://play-lh.googleusercontent.com/c3yZ05kZ0ArQZ59j-4K64TeXRcTln3f1jKVGqeZZVOuOmr6weGJ16xFcZv78YFPmZbgt=w480-h960" alt="" className='h-14 rounded-xl'/>
          <h1>Easy Events</h1>
        </a>
